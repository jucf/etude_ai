...
# params:
   # athlete_selected: "Tamara Kroll"
   # selection_debut: "2024-04-04"
   # selection_fin: "2024-05-01"
header-includes:
- \usepackage{geometry}
...
gg_sommeil <-
  ...
  annotate(
    ...
    label = paste0(round(mean(data_filt$sleep_quality, na.rm = TRUE), digits = 2)),
    color = "black",
    hjust = -1.5,
    vjust = 0,
    size = 5,
...
gg_temps_sommeil <-
  ...
  annotate(
    ...
    label = paste0(round(mean(data_filt$sleep_time, na.rm = TRUE), digits = 2)),
    color = "black",
    hjust = -1.5,
    vjust = 0,
    size = 5,
